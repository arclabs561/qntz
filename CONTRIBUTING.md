# Contributing to qntz

Thanks for your interest. qntz is vector quantization primitives (RaBitQ, ternary, bit packing) for ANN systems.
...
- Commit messages: `qntz: short lowercase description`. One commit per logical change.
